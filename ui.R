...
shinyUI(pageWithSidebar(
   headerPanel("Prediction of Diamond Price"),
      ...
      submitButton('Submit'),
      br(),
                p(strong(em("Documentation:",a("Diamond price",href="http://rpubs.com/srilakshmiuppalapati/ReproduciblePitch")))),
                p(strong(em("Github repository:",a("Diamond price",href="https://github.com/SrilakshmiUppalapati/ShinyApp/"))))
