...
## Data Preparation
Read the dataset [Diamond_price.csv](https://github.com/SrilakshmiUppalapati/ShinyApp) which is in the current directory.
```{r}
...
The shiny appication I developed has been published in shiny server at [https://sriuppalapati.shinyapps.io/DataProducts/](https://sriuppalapati.shinyapps.io/DataProducts/).     
To reproduce the shiny application on your local system, you need to install the relevent packages (caret and randomForest) and download diamond dataset, server.R and ui.R from github [repository](https://github.com/SrilakshmiUppalapati/ShinyApp).     
